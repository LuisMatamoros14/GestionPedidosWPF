    ...
    public partial class GestionPedidosDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_Pedidos_Clientes = new global::System.Data.DataRelation("FK_Pedidos_Clientes", new global::System.Data.DataColumn[] {
                        ...
                        this.tablePedidos.CodigoClienteColumn}, false);
        ...
        public partial class PedidosDataTable : global::System.Data.TypedTableBase<PedidosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PedidosRow AddPedidosRow(ClientesRow parentClientesRowByFK_Pedidos_Clientes, System.DateTime FechaPedido, string FormaPago) {
        ...
        public partial class PedidosRow : global::System.Data.DataRow {
            ...
            public int CodigoCliente {
                get {
                    return ((int)(this[this.tablePedidos.CodigoClienteColumn]));
                }
                set {
                    this[this.tablePedidos.CodigoClienteColumn] = value;
                }
            }
...
namespace ConexionGestionPedidos.GestionPedidosDataSetTableAdapters {
    ...
    public partial class ArticulosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Articulos] WHERE (([Id] = @Original_Id) AND ((@IsNull_Seccion = 1 AND [Seccion] IS NULL) OR ([Seccion] = @Original_Seccion)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)) AND ((@IsNull_NombreArticulo = 1 AND [NombreArticulo] IS NULL) OR ([NombreArticulo] = @Original_NombreArticulo)) AND ((@IsNull_PaisOrigen = 1 AND [PaisOrigen] IS NULL) OR ([PaisOrigen] = @Original_PaisOrigen)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)))";
...
SELECT Id, Seccion, Fecha, NombreArticulo, PaisOrigen, Precio FROM Articulos WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Articulos] SET [Seccion] = @Seccion, [Fecha] = @Fecha, [NombreArticulo] = @NombreArticulo, [PaisOrigen] = @PaisOrigen, [Precio] = @Precio WHERE (([Id] = @Original_Id) AND ((@IsNull_Seccion = 1 AND [Seccion] IS NULL) OR ([Seccion] = @Original_Seccion)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)) AND ((@IsNull_NombreArticulo = 1 AND [NombreArticulo] IS NULL) OR ([NombreArticulo] = @Original_NombreArticulo)) AND ((@IsNull_PaisOrigen = 1 AND [PaisOrigen] IS NULL) OR ([PaisOrigen] = @Original_PaisOrigen)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)));
...
SELECT Id, Nombre, Direccion, Poblacion, Telefono FROM Clientes WHERE (Id = @Id)";
    ...
    public partial class PedidosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Pedidos] WHERE (([Id] = @Original_Id) AND ([CodigoCliente] = @Original_CodigoCliente) AND ((@IsNull_FechaPedido = 1 AND [FechaPedido] IS NULL) OR ([FechaPedido] = @Original_FechaPedido)) AND ((@IsNull_FormaPago = 1 AND [FormaPago] IS NULL) OR ([FormaPago] = @Original_FormaPago)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pedidos] ([CodigoCliente], [FechaPedido], [FormaPago]) VALUES " +
                "(@CodigoCliente, @FechaPedido, @FormaPago);\r\nSELECT Id, CodigoCliente, FechaPedi" +
                "do, FormaPago FROM Pedidos WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT Id, CodigoCliente, FechaPedido, FormaPago FROM Pedidos WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, CodigoCliente, FechaPedido, FormaPago FROM dbo.Pedidos";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
